...
var import_msw = require("msw"), movies = [
  {
  ...
  import_msw.http.get("https://api.example.com/movies/featured", () => import_msw.HttpResponse.json(movies)),
  import_msw.http.get("https://api.example.com/movies/:slug", ({ params }) => {
    let { slug } = params, movie = movies.find((movie2) => movie2.slug === slug);
    return movie ? import_msw.HttpResponse.json(movie) : new import_msw.HttpResponse("Not found", { status: 404 });
  })
];
